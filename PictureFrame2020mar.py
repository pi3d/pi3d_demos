...
font = pi3d.Font(FONT_FILE, codepoints=CODEPOINTS, grid_size=7, background_color=(0, 0, 0, 128))
text = pi3d.PointText(font, CAMERA, max_chars=200, point_size=30)
textblock = pi3d.TextBlock(x=-DISPLAY.width * 0.5 + 14, y=DISPLAY.height * 0.5 - 20, justify=1.0,
                          z=0.1, rot=90.0, char_count=199,
                          text_format="{}".format(" "), size=0.99, 
                          spacing="F", space=0.18, colour=(1.0, 1.0, 1.0, 1.0))
