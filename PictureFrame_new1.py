...
try:
  ...
  client = mqtt.Client()
  client.username_pw_set("mhqolkbo", "GjIZqW03He7r") # replace with your own id
...
DISPLAY = pi3d.Display.create(x=150, y=50, frames_per_second=FPS, background=BACKGROUND)
